...
// Watches for file edits inside the sandpack editor to save changes to DB and live state
...
const PreviewPanel = ({ project, activeFile, showCode, darkMode }) => {
  ...
  return (
    <div className={`h-full w-full transition-colors duration-300 ${darkMode ? "bg-[#0a0f0c]" : "bg-white"}`}>
